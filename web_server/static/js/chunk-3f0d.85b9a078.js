(window.webpackJsonp = window.webpackJsonp || []).push([
  ["chunk-3f0d"],
  {
    ...
    jNvO: function (s, t, i) {
      ...
      var n = [
          function () {
            var s = this.$createElement,
              t = this._self._c || s;
            return t("div", { staticClass: "pic-404" }, [
              t("img", {
                staticClass: "pic-404__parent",
                attrs: { src: i("o2sD"), alt: "404" },
              }),
              this._v(" "),
              t("img", {
                staticClass: "pic-404__child left",
                attrs: { src: i("Jvyq"), alt: "404" },
              }),
              this._v(" "),
              t("img", {
        ...
        r = {
          ...
          computed: {
            message: function () {
              return "阿呆说这个页面你不能进...... 欢迎到他的知识星球 寻找运营黑工具";
            },
          },
        },
        l = (i("oVX0"), i("KHd+")),
        e = Object(l.a)(
          ...
          function () {
            var s = this,
              t = s.$createElement,
              i = s._self._c || t;
            return i("div", { staticClass: "wscn-http404-container" }, [
              i("div", { staticClass: "wscn-http404" }, [
                s._m(0),
                s._v(" "),
                i("div", { staticClass: "bullshit" }, [
                  i("div", { staticClass: "bullshit__oops" }, [s._v("OOPS!")]),
                  s._v(" "),
                  i("div", { staticClass: "bullshit__headline" }, [
                    s._v(s._s(s.message)),
                  ]),
                  s._v(" "),
                  i("div", { staticClass: "bullshit__info" }, [
                    s._v("阿呆和他的新媒体朋友"),
                  ]),
                ]),
              ]),
      ...
      e.options.__file = "404.vue";
      t.default = e.exports;
    },
    o2sD: function (s, t, i) {
      s.exports = i.p + "static/img/404.a57b6f3.png";
    },
    oVX0: function (s, t, i) {
      "use strict";
      var n = i("3gJn");
